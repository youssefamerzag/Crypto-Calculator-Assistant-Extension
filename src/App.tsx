...
function App() {
  ...
  return (
    <div className='container'>
      <div className='card'>
        <div className='links'>
          <a href='https://github.com/youssefamerzag' target="_blank"><img width="30" height="30" src="https://img.icons8.com/ios-glyphs/30/FFFFFF/github.png" alt="github" /></a>
          <a href='https://www.linkedin.com/in/youssefamerzag/' target="_blank"><img width="30" height="30" src="https://img.icons8.com/ios-glyphs/30/FFFFFF/linkedin.png" alt="linkedin" /></a>
        ...
        <div>
          <KofiButton color="#0a9396" title="Support Me on Ko-fi" kofiID="D1D811635P" />
        </div>
      </div>
    </div>
  );
